...
.controller('myApp.posts.viewPost', ['$routeParams', '$rootScope', 'myApp.courses.courseTagsService',
  'myApp.courses.coursesService', 'myApp.posts.postTagsService', 'myApp.posts.postsService',
function($routeParams, $rootScope, courseTagsService, coursesService, postTagsService, postsService) {
  var self = this;
